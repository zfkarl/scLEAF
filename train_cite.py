...
if __name__ == "__main__":
    ...
    # Dataset
    parser.add_argument("--rna_data_path", type=str, default='./data/citeseq_control_rna.npz')
    parser.add_argument("--rna_text_path", type=str, default='./data/text_embeddings_cite.npy')
    parser.add_argument("--rna_label_path", type=str, default='./data/citeseq_control_cellTypes.txt')
    parser.add_argument("--atac_data_path", type=str, default='./data/asapseq_control_atac.npz')
    parser.add_argument("--atac_text_path", type=str, default='./data/text_embeddings_asap.npy')
    parser.add_argument("--atac_label_path", type=str, default='./data/asapseq_control_cellTypes_v2.txt')
    parser.add_argument("--gene_emb_path", type=str, default='./data/cite-asap-gene-emb.npy')
    # DataModule
